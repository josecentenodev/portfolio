export const experienceData = [
    {
      ...
      activities: [
        "Actualmente estoy trabajando en un proyecto para Aurelia, una empresa que brinda soluciones tecnológicas en Córdoba, Argentina",
        "Principalmente trabajo con Next.js, TypeScript, TailwindCSS, PostgreSQL, Prisma, Docker, Supabase, Vercel",
        "Me encargué del diseño de la arquitectura de un CRM con inteligencia artificial, para la gestión de clientes, contactos, oportunidades, etc.",
      ],
    },
    {
      title: "Desarrollador Full Stack",
      ...
      activities: [
        ...
        "Mejoré considerablemente la interfaz de uno de los proyectos de la empresa, una aplicación web de digitalización de documentos",
        "Construí una aplicación web para la gestión de clientes con usuarios y permisos de acceso a distintas aplicaciones de la empresa, brindándole la posibilidad de tener control sobre los clientes y sus aplicaciones, también senté las bases para monitorear el uso de las aplicaciones",
        "En 2025 comencé con un gran desafío: el desarrollo de una aplicación web para el gobierno de la provincia de Córdoba, Argentina, que es una aplicación web para la gestión de solicitudes de servicios de los ciudadanos",
